...
symbol = st.text_input("Enter Stock Ticker Symbol", value="SHRIPISTON,INDNIPPON,PIDILITIND,SHANKARA,SUDARSCHEM,GABRIEL,KIRLOSBROS,CAMPUS,PDSL,DREDGECORP,HARSHA,EMUDHRA,FILATEX,GLENMARK")
